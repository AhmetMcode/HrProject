...
namespace HrProject.Presentation.Data.Migrations
{
    ...
    [Migration("20231217230254_AddMoneyTransfers")]
    partial class AddMoneyTransfers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.MoneyTransfers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.OutWaybill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EntryInvoiceAdressId")
                        .HasColumnType("int");

                    b.Property<int>("ExitInvoiceAdressId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EntryInvoiceAdressId");

                    b.HasIndex("ExitInvoiceAdressId");

                    b.HasIndex("StockId");

                    b.ToTable("OutWaybills");
                });
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.StockChange", b =>
                {
                    ...
                    b.Property<string>("AuthorizingUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.OutWaybill", b =>
                {
                    ...
                    b.HasOne("HrProject.Domain.Entities.InvoiceAdress", "EntryInvoiceAdress")
                        .WithMany()
                        .HasForeignKey("EntryInvoiceAdressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HrProject.Domain.Entities.InvoiceAdress", "ExitInvoiceAdress")
                        .WithMany()
                        .HasForeignKey("ExitInvoiceAdressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("EntryInvoiceAdress");

                    b.Navigation("ExitInvoiceAdress");
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.StockChange", b =>
                {
                    ...
                    b.HasOne("HrProject.Domain.Entities.ApplicationUser", "AuthorizingUser")
                        .WithMany()
