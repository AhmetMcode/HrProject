...
namespace HrProject.Presentation.Data.Migrations
{
    ...
    [Migration("20231204134605_AddStockBarcode")]
    partial class AddStockBarcode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.StockChange", b =>
                {
                    ...
                    b.Property<string>("AuthorizingUserId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HrProject.Domain.Entities.StockChange", b =>
                {
                    ...
                    b.HasOne("HrProject.Domain.Entities.ApplicationUser", "AuthorizingUser")
                        .WithMany()
                        .HasForeignKey("AuthorizingUserId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
